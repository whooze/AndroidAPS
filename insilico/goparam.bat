...
adb shell am broadcast -a org.nightscout.androidaps.ACTION_READ_SF  --es "target" "6.5" --ei "configuration" "%2" --es "refreshScreen" "true" --es "input" "input.txt" --es "output" "output.txt"
